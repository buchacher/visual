...
{'classifier__class_weight': None, 'classifier__criterion': 'gini', 'classifier__n_estimators': 100, 'classifier__n_jobs': -1, 'classifier__oob_score': True, 'classifier__random_state': 0, 'ftselector__k': 100, 'prepper__drop_id_bounding': False, 'prepper__filter_characteristics': 'none'}

Current target: texture
Training set balanced accuracy: 0.998
Grid search - optimal params:
{'classifier__class_weight': None, 'classifier__criterion': 'gini', 'classifier__n_estimators': 20, 'classifier__n_jobs': -1, 'classifier__oob_score': True, 'classifier__random_state': 0, 'ftselector__k': 100, 'prepper__drop_id_bounding': False, 'prepper__filter_characteristics': 'none'}
"""