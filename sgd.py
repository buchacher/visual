...
params = {
    ...
    'classifier__loss': ['hinge', 'squared_hinge', 'modified_huber', 'log', 'perceptron'],
...
Training set balanced accuracy: 0.394
Grid search - optimal params:
{'classifier__alpha': 0.01, 'classifier__early_stopping': True, 'classifier__loss': 'modified_huber', 'classifier__n_iter_no_change': 10, 'classifier__penalty': 'l1', 'classifier__random_state': 0, 'ftselector__k': 200, 'prepper__drop_id_bounding': False, 'prepper__filter_characteristics': 'none'}

Current target: texture
Training set balanced accuracy: 0.337
Grid search - optimal params:
{'classifier__alpha': 0.01, 'classifier__early_stopping': True, 'classifier__loss': 'modified_huber', 'classifier__n_iter_no_change': 10, 'classifier__penalty': 'l1', 'classifier__random_state': 0, 'ftselector__k': 200, 'prepper__drop_id_bounding': False, 'prepper__filter_characteristics': 'none'}
"""
