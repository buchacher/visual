...
params = {
    ...
    'classifier__C': [0.0001, 0.001, 0.01, 0.1, 1.0, 2.0],
...
Training set balanced accuracy: 0.431
Grid search - optimal params:
{'classifier__C': 1.0, 'classifier__class_weight': 'balanced', 'classifier__gamma': 'scale', 'classifier__kernel': 'linear', 'classifier__random_state': 0, 'ftselector__k': 10, 'prepper__drop_id_bounding': False, 'prepper__filter_characteristics': 'hog'}

Current target: texture
Training set balanced accuracy: 0.481
Grid search - optimal params:
{'classifier__C': 0.1, 'classifier__class_weight': 'balanced', 'classifier__gamma': 'scale', 'classifier__kernel': 'sigmoid', 'classifier__random_state': 0, 'ftselector__k': 50, 'prepper__drop_id_bounding': False, 'prepper__filter_characteristics': 'hog'}
"""
